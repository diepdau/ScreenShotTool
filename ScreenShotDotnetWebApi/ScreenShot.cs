...
namespace ScreenshotTool
{
    public class ScreenShot
    {
        ...
        public async Task<string> CaptureScreenshotAsync1(string url, int width = 1920, string customCss = "", string folderPath = "", int delayMilliseconds = 0)
        {
        ...
        public async Task<string> CaptureScreenshotAsync(string url, int width = 1920, string customCss = "", string folderPath = "", int delayMilliseconds = 0)
        {
            ...
            }, CancellationToken.None); // Hoặc truyền vào cancellationToken từ phương thức gọi
        }
